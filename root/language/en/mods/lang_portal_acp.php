...
$lang = array_merge($lang, array(
	...
	'PORTAL_GLOBAL_ANNOUNCEMENTS_FORUM_EXPLAIN'	=> 'Forums from which we retrieve the announcements. Leave this blank to retrieve announcements from all the forums. If &#39;Exclude forums&#39; is set to &#39;Yes&#39;, select the forums you want to exclude.<br />If &#39;Exclude forums&#39; is set to &#39;No&#39; select the forums you want to see.<br />Select/Deselect multiple forums by holding <samp>CTRL</samp> and clicking.',
	...
	'PORTAL_NEWS_FORUM_EXPLAIN' 		=> 'Forums we pull the articles from, leave blank to pull from all forums. If &#39;Exclude forums&#39; is set to &#39;Yes&#39;, select the forums you want to exclude.<br />If &#39;Exclude forums&#39; is set to &#39;No&#39; select the forums you want to see.<br />Select/Deselect multiple forums by holding <samp>CTRL</samp> and clicking.',
	...
	'PORTAL_RECENT_FORUM_EXPLAIN'			=> 'Forums we pull the topics from, leave blank to pull from all forums. If &#39;Exclude forums&#39; is set to &#39;Yes&#39;, select the forums you want to exclude.<br />If &#39;Exclude forums&#39; is set to &#39;No&#39; select the forums you want to see.<br />Select/Deselect multiple forums by holding <samp>CTRL</samp> and clicking.',
